...
class App(threading.Thread):
    ...
    def run(self):
        self.root = tk.Tk()
        self.root.wm_title("GPIO EMULATOR - COLLAR ACTUATORS")
        ...
        #GPIO17
        pin11btn = Button(text="CAMERA-17\nCOLLAR", command="17", padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
        pin11btn.grid(row=1, column=5, padx=(10, 10))

        dictionaryPinsTkinter["17"] = pin11btn

        #GPIO27
        pin13btn = Button(text="SPEAKER-27\nCOLLAR", command="27", padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
        pin13btn.grid(row=1, column=6, padx=(10, 10))

        dictionaryPinsTkinter["27"] = pin13btn

        #GPIO22
        pin15btn = Button(text="MIC-22\nCOLLAR", command="22", padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
        ...
        #GPIO11
        pin23btn = Button(text="REMOTE-11\nCOLLAR", command="11", padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
