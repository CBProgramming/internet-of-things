...
class App(threading.Thread):
    ...
    def run(self):
        self.root = tk.Tk()
        self.root.wm_title("GPIO EMULATOR - FEEDER ACTUATOR")
        ...
        #GPIO10
        pin19btn = Button(text="FEEDER-10", command="10",  padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
