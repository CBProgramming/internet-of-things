...
class App(threading.Thread):
    ...
    def run(self):
        self.root = tk.Tk()
        self.root.wm_title("GPIO EMULATOR - CAMERA OUTSIDE2 ACTUATOR")
        ...
        #GPIO23
        pin16btn = Button(text="CAMERA-23\nOUTSIDE2", command="23", padx ="1px", pady="1px", bd="0px", fg="blue", relief="sunken", activeforeground="blue")
